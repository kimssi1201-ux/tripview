...
function makeArticle(candidate, common, intro, images, category, today) {
  ...
  const faq = isFestival
    ? [['무료인가요?', `요금 기준은 ${fee}입니다. 일부 체험과 먹거리 이용 비용은 별도일 수 있습니다.`], ['언제 도착하면 좋나요?', '대표 프로그램을 보려면 시작 시간보다 여유 있게 도착해 접수 위치와 관람 구역을 먼저 확인하는 편이 좋습니다.'], ['아이와 함께 가도 괜찮나요?', '가능합니다. 다만 실외 대기 시간이 생길 수 있어 물, 모자, 편한 신발을 준비하세요.']]
