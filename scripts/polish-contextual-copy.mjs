...
function buildTravelSections(post) {
  ...
  return [
    ...
    [
      "계절별 방문 팁",
      [
        `${title}을 ${destination(region)} 넣는다면 시간대 선택이 중요합니다. 오전에는 이동과 관람을 먼저 하고, 한낮에는 실내 휴식이나 식사 시간을 넣은 뒤, 늦은 오후에 산책이나 사진 촬영을 붙이면 일정이 훨씬 안정적으로 이어집니다.`,
        `한 장소를 길게 보는 일정이라면 주변 목적지를 많이 붙이기보다 가까운 식사 장소, 카페, 짧은 산책 구간 정도만 연결하는 편이 좋습니다. 특히 주말에는 주차와 대기 시간이 예상보다 길어질 수 있으니 돌아오는 시간을 넉넉히 남겨두세요.`,
