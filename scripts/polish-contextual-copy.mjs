...
const VERSION = 2;
const TENPING_AD = `<div class="tenping-ad"><span class="ad-label">광고</span><tenping class="adsbytenping" style="width: 100%; margin: 0px auto; display: block; max-width: 768px; min-height: 110px;" tenping-ad-client="%2fnyDIt3jSiYh7KXeo4%2bsm7S2Hydb6U%2fzbuFekGjT%2frlZrkiEUQ%2btrnyYLz7zJ6Li" tenping-ad-display-type="1LawCE8FqKOhetXZhMopsQ%3d%3d"></tenping></div><script async src="https://ads.tenping.kr/scripts/adsbytenping.min.js"></script>`;
...
<html lang="ko">
  ...
  <body>
    ...
    <main>
      ...
      ${gallery}
      <section class="wrap layout"><article class="content"><table class="info-table"><tbody>${rows}</tbody></table>${TENPING_AD}${sections}<h2>자주 묻는 질문</h2>${faqs}<p class="note">일정과 세부 운영은 현장 사정에 따라 달라질 수 있습니다. 출발 전 당일 공지를 한 번 더 확인하면 불필요한 이동을 줄일 수 있습니다.</p>${TENPING_AD}</article><aside class="aside"><strong>운영 메모</strong>${memo}<a href="../">목록으로 돌아가기</a></aside></section>
    </main>
