...
const I18N_SCRIPT = '<script src="/assets/i18n.js?v=link-i18n-20260706" defer></script>';
const TOPIC_FILTER_SCRIPT = '<script src="/assets/topic-filter.js?v=link-i18n-20260706" defer></script>';
